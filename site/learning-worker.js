/* A fresh two-letter experiment on the complete FlyWire network. The graph is
 ...
 */
'use strict';
importScripts('live-model.js', 'learning-model.js', 'connectome-loader.js');
...
function begin(options) {
  experiment = new FlyHamletLearning.LearningExperiment(connectome, manifest, requestedSeed, options);
