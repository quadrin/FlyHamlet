/* A fresh phrase-recall experiment on the complete FlyWire network. The graph is
 ...
 */
'use strict';
importScripts('live-model.js', 'recall-model.js', 'connectome-loader.js');
...
function begin(options) {
  experiment = new FlyHamletRecall.RecallExperiment(connectome, manifest, requestedSeed, options);
